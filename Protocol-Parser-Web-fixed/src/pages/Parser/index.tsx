...
const MenuManagement = lazy(() => import("../Admin/MenuManagement"));
const SystemSettings = lazy(() => import("../SystemSettings"));
const VehicleManagement = lazy(() => import("../BasicInfo/VehicleManagement"));
const DeviceInventory = lazy(() => import("../BasicInfo/DeviceInventory"));
const DeviceMaintenance = lazy(() => import("../BasicInfo/DeviceMaintenance"));
const OrganizationManagement = lazy(() => import("../BasicInfo/OrganizationManagement"));
const FinanceCompanyManagement = lazy(() => import("../BasicInfo/FinanceCompanyManagement"));
const FinanceProductManagement = lazy(() => import("../BasicInfo/FinanceProductManagement"));
const CollectionCompanyManagement = lazy(() => import("../BasicInfo/CollectionCompanyManagement"));
